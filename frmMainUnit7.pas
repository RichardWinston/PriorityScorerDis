...
//  PartBValuePercentCol = 4;
  ...
  ProblemLabels: array[0..9] of string = ('Fetal_Distress', 'PreE',
    'Breech', 'Cesarean', 'Pain', 'Preterm', 'PNC', 'Labor_Status',
    'Teen', 'Knowl_Deficit');
...
//      Sheet.Cells[TotalsPartARow, InterventionsKeyCol].Value := TotalInterventionsKey;
      // Lily decided to change the number of interventions to 23 for the purposes
      // of scoring but to leave 55 on the spreadsheet.
      TotalInterventionsKey := 23;
      ...
      TotalsTitleLineBuilder.Append('Total_Problems_Identified, ');
//      LineBuilder.Append('Problems_Identified_Percent, ');
  ...
  //      AString := RangeMatrix[RowIndex,ProblemLabelCol];
      ...
      TotalsTitleLineBuilder.Append('Total_Problems_Repeated, ');

      TotalsTitleLineBuilder.Append('NumWrong, ');
//      LineBuilder.Append('NumWrong_Percent, ');
      ...
      begin
        AString := ProblemLabels[RowIndex-FirstDataRowPartA];
        LineBuilder.Append(AString);
        LineBuilder.Append('_Priority_Pts, ');
      end;

      TotalsTitleLineBuilder.Append('Priority_SubScore, ');
      TotalsTitleLineBuilder.Append('Total_Priority_Score_Pc, ');
...
//      LineBuilder.Append('Total_Priority_Score_Percent, ');
      ...
      begin
        ...
        begin
          LineBuilder.Append(AString);
          LineBuilder.Append('_Evidence_');
          LineBuilder.Append(EvidenceTypes[EvidenceIndex]);
          LineBuilder.Append(', ');
        end;
      end;
      TotalsTitleLineBuilder.Append('Total_Evidence, ');
      TotalsTitleLineBuilder.Append('Evidence_Percent, ');
      ...
      begin
        ...
        begin
          LineBuilder.Append(AString);
          LineBuilder.Append('_Interventions_');
          LineBuilder.Append(EvidenceTypes[EvidenceIndex]);
          LineBuilder.Append(', ');
        end;
      end;

      TotalsTitleLineBuilder.Append('Interventions_Total, ');
      TotalsTitleLineBuilder.Append('Interventions_Percent, ');
      ...
      begin
        ...
        begin
          LineBuilder.Append(AString);
          LineBuilder.Append('_Outcomes_');
          LineBuilder.Append(EvidenceTypes[EvidenceIndex]);
          LineBuilder.Append(', ');
        end;
      end;
      TotalsTitleLineBuilder.Append('Outcomes_Total, ');
      TotalsTitleLineBuilder.Append('Outcomes_Percent, ');

      TotalsTitleLineBuilder.Append('EIO_Percent, ');
      ...
      begin
        ...
        begin
          LineBuilder.Append(AString);
          LineBuilder.Append('_Identified_');
          LineBuilder.Append(EvidenceTypes[EvidenceIndex]);
          LineBuilder.Append(', ');
        end;
      end;
      ...
      TotalsTitleLineBuilder.Append('LMD_pc, ');
      TotalsTitleLineBuilder.Append('Total, ');
...
//        PriorityScoreTotal := PriorityScoreTotal;// - MinimumPriorityScore;
        ...
        PriorityScoreFraction := (PriorityScoreTotal-MinimumPriorityScore)/PriorityScoreRange;
        Sheet.Cells[TotalPriorityScoreRow, PriorityScoreCol].Value := PriorityScoreFraction;
...
//          Sheet.Cells[RowIndex, EvidencePercentCol].Value := Evidence/MaxKey;
  ...
  //    Evidence Percent
        ...
        begin
          TotalEvidencePercent := TotalEvidence/MaxEvidenceForParticipant;
        end
        else
        begin
...
//          Sheet.Cells[RowIndex, InterventionsPercentCol].Value := Intervetions/MaxKey;
        ...
        begin
          TotalInterventionsPercent := TotalInterventions/MaxInterventionsForParticipant;
        end
        else
        begin
...
//          Sheet.Cells[RowIndex, OutcomesPercentCol].Value := Outcomes/MaxKey;
        ...
        begin
          TotalOutcomesPercent := TotalOutcomes/MaxOutcomesForParticipant;
        end
        else
        begin
...
//        Sheet.Cells[PercentPartARow, OutcomesCol].NumberFormat := '0%';
        ...
        Sheet.Cells[TotalPriorityScoreRow, InterventionsPercentCol].Value := EIO_Percent;
...
//          Sheet.Cells[PartBValuePercentRow, ColIndex].Value := AValue/MaxKey;
        ...
        begin
          ...
          LineBuilder.Append(PartBValues[ColIndex]);
          LineBuilder.Append(', ');
        end;
        AveragePartB := AveragePartB/Length(PartBValues);
        TotalsLineBuilder.Append(AveragePartB);
        TotalsLineBuilder.Append(', ');
        Sheet.Cells[TotalPriorityScoreRow, Succ(FirstDataColPartB)].Value := AveragePartB;
